...
public class TraderData : IUnitData
{
	...
	public bool secondaryPrefab, isMoving, interruptedRoute, atStop, followingRoute, isWaiting, isUpgrading, paid, hasRoute, waitingOnRouteCosts, ambush, guarded, waitingOnGuard, guardLeft;
